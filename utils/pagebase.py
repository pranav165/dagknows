...
from selenium.common.exceptions import StaleElementReferenceException, \
    ElementNotVisibleException, TimeoutException, ElementNotInteractableException, ElementClickInterceptedException
import os


class PageNotFullyLoadedException(Exception):
    pass
...
class PageBase(object):
    ...
    def __get_by(self, locator_with_strategy):  # to locate element by id/xpath etc
        ...
        if strategy == Strategy.XPATH.value:
            ...
            by = (By.ID, locator)
        elif strategy == Strategy.CSS.value or Strategy.SHADOW.value:
    ...
    def wait_till_element_is_present(self, locator, timeout=60):
        """
    ...
    def wait_till_element_is_not_present(self, locator, timeout=10):
        """
